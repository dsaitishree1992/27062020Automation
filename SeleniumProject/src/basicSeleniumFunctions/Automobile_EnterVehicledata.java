...
public class Automobile_EnterVehicledata {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(isSelected);
		  ...
		  ins= new Select(insuranceDropDown); ins.selectByIndex(3);
		  
		  WebElement meritDropDown=dr.findElement(By.name("Merit Rating")); Select mer=
		  new Select(meritDropDown); mer.selectByIndex(3);
		  
		  WebElement damageDropDown=dr.findElement(By.name("Damage Insurance")); Select
		  dam= new Select(damageDropDown); dam.selectByIndex(2); Thread.sleep(3000);
		  
		  dr.findElement(By.xpath("//input[@id='EuroProtection']//following::span[1]"))
		  .click(); WebElement carDropDown=dr.findElement(By.name("Courtesy Car"));
		  Select car= new Select(carDropDown); car.selectByVisibleText("Yes");
		  dr.findElement(By.id("nextselectpriceoption")).click();
		  dr.findElement(By.xpath("//input[@id='selectsilver']//following::span[1]")).
		  click(); // Select Silver Thread.sleep(1000);
		  ...
		  dr.findElement(By.id("Comments")).
		  sendKeys("Send the quotation as per given info.");
